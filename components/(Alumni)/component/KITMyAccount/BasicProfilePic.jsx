...
const BasicProfilePic = () => {
  ...
  const [state, setState] = useSetState({btnLoading:false,});
  ...
  const ProfileImageGet = async () => {
    try {
      const res = await axios?.get(`${BaseURL}/profile_picture/${id}/`, {
        headers: {
      ...
      onOk() {
        {
          !previewImage
            ? setPreviewImage(null)
            : axios
                .delete(`${BaseURL}/profile_picture/${id}/`, {
                  headers: {
                    Authorization: `Bearer ${localStorage.getItem('token')}`,
                  },
                })
            ...
            <div className='row g-5'>
              <div className='col-lg-3 col-12'>
                <div className='rbt-my-account-tab-button nav' role='tablist'>
                   <Link href={`/edit-basic-profile/${id}`} >
                        Basic Details
                      </Link>
                      ...
                      <div className='form-wrapper'>
                        <div className=' contact-form-style-1 max-width-auto py-0 px-3'>
                          ...
                          >
                            {/* Left Column */}
                            <div
                              className={`${previewImage ? 'd-flex gap-5' : ''
                                }`}
                            >
                              {previewImage ? (
                            ...
                            <div className='form-submit-group'>
                              <button
                                ...
                                className={`rbt-btn btn-md btn-gradient hover-icon-reverse ${state.btnLoading ? 'loading' : ''
                                  }`}
                              >
                                {state.btnLoading ? (
...
export default BasicProfilePic;
