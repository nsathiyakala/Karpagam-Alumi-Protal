...
const BasicExperienceMain = () => {
  ...
  const GetMemberEducation = async () => {
    ...
    try {
      const res = await Models.member.member_experience(id);
                ...
                <div className='col-lg-3 col-12'>
                  <div className='rbt-my-account-tab-button nav' role='tablist'>
                    <Link href={`/edit-basic-profile/${id}`} >
                      ...
                      <Link href={`/edit-profile-experience/${id}`} className="active">Experience</Link>
...
export default BasicExperienceMain;
