...
const BasicDetailMain = () => {
  ...
  const GetMemberData = async () => {
    try {
      ...
      setFormData({
        ...
        batch: {value:res.batch_detail.id,
          label:res.batch_detail.title
        } || "",
        course:{value:res.course_detail.id,
          label:res.course_detail.title
        } || "",
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${BaseURL}/member_data/${id}/`, body, {
        headers: {
                ...
                <div className="row g-5">
                  <div className="col-lg-3 col-12">
                    <div
                      ...
                      role="tablist"
                    >
                      <Link href={`/edit-basic-profile/${id}`} className="active">
                        Basic Details
                      </Link>
...
export default BasicDetailMain;
